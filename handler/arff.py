...
from handler.utils import (
    ARFF_PATH, PTID_COL, CLUSTERING_PATH, CLUSTER_ID_COL, NUMERIC_COL_TYPE, COMBINED_PATH, COMBINED_COL_TYPES_PATH
)


def arff_handler(cohort: str):
    ...
    save_data(arff_data=data, col_types=col_types, target_col=CLUSTER_ID_COL, cohort=cohort)
